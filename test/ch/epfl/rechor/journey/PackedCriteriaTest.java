...
class PackedCriteriaTest {
    ...
    void packedCriteriaPackThrowsWithInvalidArrivalTimes() {
        assertThrows(IllegalArgumentException.class, () -> PackedCriteria.pack(-4 * 60 - 1, 0,
                0));
        assertThrows(IllegalArgumentException.class, () -> PackedCriteria.pack(48 * 60, 0, 0));
    }

    @Test
    void packedCriteriaPackThrowsWithInvalidChanges() {
        assertThrows(IllegalArgumentException.class, () -> PackedCriteria.pack(0, -1, 0));
        assertThrows(IllegalArgumentException.class, () -> PackedCriteria.pack(0, 128, 0));
    }
    ...
    void packedCriteriaDepMinsThrowsWithoutDepMins() {
        assertThrows(IllegalArgumentException.class, () -> PackedCriteria.depMins(PackedCriteria.pack(1,
                2, 3)));
    }
    ...
    void packedCriteriaDominatesOrIsEqualThrowsWithIncompatibleTuples() {
        ...
        assertThrows(IllegalArgumentException.class, () -> PackedCriteria.dominatesOrIsEqual(t1, t2));
    }
