...
/**
 * Interface provides methods to access and manage various components of a public transport
 * timetable
 *
...
public interface TimeTable {
     ...
     * @return an instance of {@link Connections} containing the connections valid on the given
     * date.
     */
    ...
    /**
     * Determines whether the given stop ID corresponds to a platform or track rather than a
     * station.
     *
     * @param stopId the ID of the stop to test
