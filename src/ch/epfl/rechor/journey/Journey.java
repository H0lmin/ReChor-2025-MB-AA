...
/**
 * Represents a complete journey, which is a sequence of alternating legs
...
public record Journey(List<Leg> legs) {
     ...
     * <p>
     * A leg is a segment of the journey with its own departure and arrival stops and times.
     * Legs can be either a transport leg (a ride in a vehicle) or a foot leg (walking).
     * </p>
     */
    public sealed interface Leg {
         ...
         * <p>
         * For a transport leg, these are the stops between the departure and arrival stops.
         * For a foot leg, the list is always empty.
         * </p>
         *
        ...
        record IntermediateStop(Stop stop, LocalDateTime arrTime, LocalDateTime depTime) {
             ...
             * @throws IllegalArgumentException if the departure time from the stop isn't before the arrival time at the stop
             */
        ...
        record Foot(Stop depStop, LocalDateTime depTime, Stop arrStop, LocalDateTime arrTime) implements Leg {
            ...
            /**
             * Determines if this foot leg represents a transfer, i.e. a walk within the same station.
             *
